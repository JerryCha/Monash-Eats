            ...
            // Log out
                    ...
                    try {
                        ...
                        do {
                            ...
                            if (subCmds[0].equals("add"))
                                ...
                                try {
                                    HashMap<String, String> itemInfo = restaurantController.viewItem(resId, Integer.parseInt(subCmds[1]));
                        ...
                        } while (!subCmds[0].equals("finish") || !subCmds[0].equals("leave"));
                ...
                // Editing restaurant
                    ...
                    do {
                        ...
                        System.out.println("To save&exit, enter save. To discard, enter cancel. Any invalid selection will not be handled.");
                        System.out.println("1 - Name; 2 - Description; 3 - Address; 4 - Email; 5 - Phone. To edit coupon or menu, please type 6 or 7 only.");
                        ...
                        try {
                            ...
                            if (subCmds.length == 1 && subCmds[0].equals("7")) {
                                ...
                                System.out.println("Commands: add - add an item, edit <item id> - edit specific item, del <item id> - delete specific item, exit - exit menu edit.");
                                ...
                                do {
                                    ...
                                    if (menuCmd[0].equals("add")) {
                                        ...
                                        newItemMap.put("unitPrice", acceptDouble("New item's name: ").toString());

                                        restaurantController.editItem(resId, 'a', -1, newItemMap);  // ItemID not need for add
                                    }
                                        ...
                                        restaurantController.editItem(resId, 'd', id, null);    // info not need for deletion
                                    }
                            ...
                            // 6 - Coupon
                                ...
                                System.out.println("Commands: add - add a coupon, edit <coupon code> - edit coupon, del <coupon code> - delete coupon, exit - exit menu edit.");
                                ...
                                do {
                                    ...
                                    if (cpCmd[0].equals("add")) {
                                        ...
                                        couponMap.put("appliedItemId", acceptString("New coupon's applied item id(split by ','): "));
                                        ...
                                        HashMap<String, String> couponMap = new HashMap<>();
                                        couponMap.put("couponCode", acceptString("Coupon to be deleted by entering its code: "));
                    ...
                    } while (subCmds.length != 1 || !subCmds[0].equals("save") || !subCmds[0].equals("cancel"));
                    // Manipulating phase
                    boolean ok = false;
                    try {
                        ok = restaurantController.editRestaurant(loginId, loginRole, resId, info);
                    } catch (Exception e) {
